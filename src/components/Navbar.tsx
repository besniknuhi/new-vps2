          ...
          <div className="flex flex-row gap-2 items-center">
            ...
            <div
              className={`hidden lg:flex ${
                active
                  ? "flex-col items-start justify-start gap-[14px] px-8"
              ...
              <Link
                ...
                className={`${
                  active
                    ...
                    : "flex items-center justify-center text-sm leading-[110%] px-4 py-2 rounded-md hover:bg-[#F5F5F5] hover:text-black text-[#525252]"
                }`}
              >
                Pricing
              </Link>
